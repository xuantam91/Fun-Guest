...
export default function Dashboard({ onSelectLevel }) {
  ...
  const englishLevels = [
    ...
    { code: 'en_greetings', name: 'Chào Hỏi & Giới Thiệu', desc: 'Hello, Nice to meet you & My name is...', icon: '👋', count: '2.000' },
    { code: 'en_family', name: 'Gia Đình & Người Thân', desc: 'Father, Mother, Sister & Family', icon: '👨‍👩‍👧', count: '2.000' },
    { code: 'en_school', name: 'Trường Học & Lớp Học', desc: 'May I come in, Classroom & Subject', icon: '🎒', count: '2.000' },
    { code: 'en_food', name: 'Ăn Uống & Món Ăn', desc: 'Would you like some juice, Breakfast', icon: '🍕', count: '2.000' },
    { code: 'en_daily', name: 'Thói Quen Hàng Ngày', desc: 'What time do you wake up & Brush teeth', icon: '⏰', count: '2.000' },
    { code: 'en_hobbies', name: 'Sở Thích & Giải Trí', desc: 'What do you like, Playing football', icon: '🎨', count: '2.000' },
    { code: 'en_weather', name: 'Thời Tiết & Mùa', desc: 'How is the weather, Sunny & Rainy', icon: '☀️', count: '2.000' },
    { code: 'en_animals', name: 'Động Vật & Thú Cưng', desc: 'Do you have a pet, Cute animals', icon: '🐶', count: '2.000' },
    { code: 'en_clothes', name: 'Trang Phục & Thời Trang', desc: 'What are you wearing, Coat & Shoes', icon: '👗', count: '2.000' },
    { code: 'en_house', name: 'Nhà Cửa & Đồ Đạc', desc: 'Where is the living room, Furniture', icon: '🏡', count: '2.000' },
    { code: 'en_health', name: 'Cơ Thể & Sức Khỏe', desc: 'What is wrong, I have a headache', icon: '🏥', count: '2.000' },
    { code: 'en_colors', name: 'Màu Sắc & Hình Khối', desc: 'Red, Blue, Circle & Square', icon: '🎨', count: '2.000' },
    { code: 'en_numbers', name: 'Con Số & Đếm Số', desc: 'How many, Numbers 1-100 & Counting', icon: '🔢', count: '2.000' },
    { code: 'en_shopping', name: 'Mua Sắm & Giá Cả', desc: 'How much is this, Supermarket', icon: '🛍️', count: '2.000' },
    { code: 'en_places', name: 'Địa Điểm & Thành Phố', desc: 'Where is the library, Next to bank', icon: '🏙️', count: '2.000' },
    { code: 'en_time', name: 'Thời Gian & Lịch', desc: 'What time is it, Days of the week', icon: '📅', count: '2.000' },
    { code: 'en_travel', name: 'Giao Thông & Du Lịch', desc: 'How do you go to school, Bus & Train', icon: '🚗', count: '2.000' },
    { code: 'en_feelings', name: 'Cảm Xúc & Tâm Trạng', desc: 'How do you feel, Happy, Excited', icon: '😊', count: '2.000' },
    { code: 'en_jobs', name: 'Nghề Nghiệp & Công Việc', desc: 'What does your father do, Doctor', icon: '💼', count: '2.000' },
    { code: 'en_polite', name: 'Giao Tiếp Lịch Sự', desc: 'Thank you, Excuse me & You are welcome', icon: '🤝', count: '2.000' },
  ]
